...
public abstract class Teromino {
	protected State[] states;
	protected int index = 1000;
	protected Cell[] cells = new Cell[4];//存放四个格子
	...
	public static Teromino randomOne(){
